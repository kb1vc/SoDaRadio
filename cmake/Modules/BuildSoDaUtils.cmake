...
# SoDaUtils is a library for intelligent utilsting of text from
...
ELSE()
  ...
  IF(NOT SoDaUtils_FOUND)
    ...
    # get sodautils
    MESSAGE("Building SoDaUtils from git repo.")
    ExternalProject_Add(
      SoDaUtilsLib
    ...
    set(SoDaUtils_INCLUDE_DIRS ${SoDaUtils_ROOT}/include)
...
message("\n\nSODAUTILS BUILD\n******\n\n*****\nSoDaUtils_INCLUDE_DIRS = ${SoDaUtils_INCLUDE_DIRS}")
